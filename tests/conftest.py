...
def mock_okta_client():
    ...
    client.delete_application.return_value = (None, None, None)
    client.delete_policy.return_value = (None, None, None)
    client.delete_policy_rule.return_value = (None, None, None)
    client.deactivate_user.return_value = (None, None, None)
    client.delete_user.return_value = (None, None, None)
    client.deactivate_application.return_value = (None, None, None)
    client.deactivate_policy.return_value = (None, None, None)
    client.deactivate_policy_rule.return_value = (None, None, None)
    return client
